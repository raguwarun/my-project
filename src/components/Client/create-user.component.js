...
export default class CreateUser extends Component {
    ...
    onChangeNumber(e) {
        ...
        var data = '';
        for (let i = 0; i < len; i++) {
            data = data + '<tr><td contenteditable required></td><td contenteditable required></td><td contenteditable required></td></tr>';
        }
                ...
                <form onSubmit={this.onSubmit}>
                    ...
                    <div className="form-group">
                        ...
                        <table className="table">
                            <thead>
                                <tr><th>State Name #</th><th>GST Login #</th><th>GST Password #</th></tr>
                            </thead>
                            <tbody  id="gsttable">
                            </tbody> 
                        </table>
                    ...
                    <div className="form-group">
                        ...
                        <table className="table">
                            <thead>
                                <tr><th>Bank Name #</th><th>IFSC #</th><th>Account Number #</th></tr>
                            </thead>
                            <tbody  id="banktable">
                            </tbody> 
                        </table>
